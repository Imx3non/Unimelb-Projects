...
import pasur.Pasur;
import pasur.PointsObserver.PointsObserver;
...
public abstract class Player extends PointsObserver
{
    ...
    protected Hand surs;
    private int score = 0;
    private int permScore = 0;
    private GameLogger gameLogger;


    protected Player(int id) throws IOException {
    ...
    public final Map.Entry<Card, Set<Card>> playCard(Hand pool) throws IOException {
        ...
        if(playedCard != null)
        {
            gameLogger.write(toString() + " plays " + Pasur.toString(playedCard));
    ...
    public void calculateRoundEndScore() {
        calculateScore();
        permScore = score;
    }
    ...
    public void calculateScore() {
        ...
        int tempScore = new Scorer(pickedCards, surs).getScore();
//        score = tempScore + permScore;
        PointsTable.setScore(this, tempScore + permScore);
